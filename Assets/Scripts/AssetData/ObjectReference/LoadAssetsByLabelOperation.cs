...
namespace AssetManagement
{
    ...
    public class LoadAssetsByLabelOperation : AsyncOperationBase<List<AsyncOperationHandle<Object>>>
    {
        ...
        {
            _loadedDictionary = loadedDictionary ?? new Dictionary<object, AsyncOperationHandle>();
            _loadingDictionary = loadingDictionary ?? new Dictionary<object, AsyncOperationHandle>();
