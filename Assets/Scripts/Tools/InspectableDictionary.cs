...
{
    [Serializable]
    public class InspectableDictionary<TKey, TValue> : IDictionary<TKey, TValue> 
    {
        //---
        // Inspectable Lists
        ...
        private bool inspectableSync = false;
        private readonly Dictionary<TKey, TValue> lookup = new Dictionary<TKey, TValue>();

        public Dictionary<TKey, TValue> Dictionary => lookup;
        ...
        {
            if (ItemKeys.Count != lookup.Count || !inspectableSync)
            {
                lookup.Clear();
